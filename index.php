...
<body id="page-top">
    ...
    <!-- Navigation   Menu de navegacion-->
    <?php require_once("./modelos/menu.php")  ?>


    <!-- Mashead header-->
    <header class="masthead main">
        <div class=" px-5 mainContainer bg-dog">
            <!-- Mashead text and app badges-->
            <div class="mb-0 mb-lg-0 text-center">
                <h1 class="display-1 lh-1 mb-3">Correas Identificadoras</h1>
    ...
    <aside class="text-center bg-gradient-primary-to-secondary">
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    <img src="assets/Logo/logo.PNG" alt="Logo-Kapri" style="height: 3rem" />
                    <div class="h2 fs-1 text-dark mb-4">Una solucion innovadora para cuando un peludo se pierde</div>
                        ...
                        <div class="row gx-5">
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="text-center">
                                    <img src="./assets/img/CodigoQr.jpg" alt="" width="40%">
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-sm-8 col-md-6">
                    <div class="px-3 px-sm-4" style="text-align: center;"><img class="img-fluid rounded-circle"
                            src="./assets/img/Pets2.jpg" alt="Perro"  width="60%"/></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gradient-primary-to-secondary" id="download">
        <div class="container px-5">
            <h2 class="text-center text-dark font-alt mb-4">Consigue tu collar ahora!!</h2>
